...
namespace FoundationDB.Client {
	...
	/// </remarks>
	public struct Sid : IComparable<Sid>, IComparable
	{
		...
		public Sid(uint a, uint b, uint c, uint d)
		{
			_a = a;
			_b = b;
			_c = c;
		...
		public Sid(Guid id) : this(id.ToByteArray()) { }

		public Sid(byte[] array)
		{
		...
		public static Sid CreateNew(long offset)
		{
			var counter = Interlocked.Increment(ref _counter);
			var timestamp = GetCurrentTimestampMs();
			return new Sid(timestamp, offset, counter);
		}

		public Sid(long timestamp, long offset, int counter)
		{
